function copyClipboard(url){
    ...
    let newContent = document.createTextNode("<div className=\"bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md\" role=\"alert\">\n" +
        "        <div className=\"flex\">\n" +
        "            <div className=\"py-1\">\n" +
    ...
    let currentDiv = document.querySelector(".navbar");
